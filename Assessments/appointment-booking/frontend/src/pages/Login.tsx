...
import { getData } from "@/redux/slices/Test";
...
const Login: React.FC = () => {
  ...
  const onSubmit = async (data: DoctorFormData) => {
    try {
      ...
      if (res.data) {
        setCookie("authToken", res.data.token, 2);
        navigate("/dashboard");
      } else {
    ...
    <div className=" grid grid-cols-2 w-full h-[100vh] bg-gray-900">
      <div className="  w-full flex justify-center items-center  p-6  shadow-md rounded-md">
        <div className="w-2/3 px-10 py-12 bg-gray-100 rounded-2xl inset-shadow-yellow-600 shadow">
          ...
          <h2 className="text-3xl font-bold mb-4">Hey, Good to see you</h2>
          <h2 className="text-2xl font-semibold mb-6 ">Lets Login you</h2>
