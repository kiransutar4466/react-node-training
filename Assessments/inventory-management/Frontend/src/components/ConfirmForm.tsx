...
const ConfirmForm = ({message, buttonContent, actionCb, cancelCb}:{message:string, buttonContent:ReactNode|string ,actionCb:Function, cancelCb:Function}) => {
  return (
    <div className="w-[300px] h-[200px] bg-primary-white text-primary-black rounded-xl p-5 flex flex-col justify-between" >

     <div className="message text-left w-full pt-5">
      {message}
     </div>
