        ...
        <div className="flex flex-col">
          <Link to={"/dashboard"}>
            <Button
              ...
              classNames={
                "text-left mb-2 hover:bg-header-bg hover:text-text-dark"
              }
            />
          </Link>
          ...
          {userDetails?.role == ADMIN && (
            <Link to={"/inventory"}>
              <Button
                ...
                bgColor="primary-white"
                classNames={
                  "text-left mb-2 hover:bg-header-bg hover:text-text-dark drop-shadow-none"
                }
              />
            </Link>
          )}
          ...
          {userDetails?.role == ADMIN && (
            <Link to={"/manage-vendors"}>
              <Button
                ...
                width="full"
                color={
                  selectedTab == "manage-vendors" ? "dark-orange" : "text-dark"
                }
                bgColor="primary-white"
                classNames={
                  "text-left mb-2 hover:bg-header-bg hover:text-text-dark"
