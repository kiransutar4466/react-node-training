const Loader = () => {
  return (
    <div className="w-full h-[100vh] flex justify-center items-center ">
      ...
      <div
        className={`w-22 h-22 border-4 border-transparent text-primary-orange text-4xl animate-spin flex items-center justify-center border-t-primary-orange rounded-full`}
      >
