...
export const {startVendorApiRequest, successCreateVendor,  failVendorApiRequest, successFetchAllVendors, successFetchVendorById, successEditVendor, successDeleteVendorById, deselectVendor} = vendorSlice.actions;