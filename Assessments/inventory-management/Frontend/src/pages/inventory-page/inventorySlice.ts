...
export const {startInventoryApiRequest, successFetchAllInventories, successFetchInventoryById , successEditInventory, failInventoryApiRequest, deselectInventory}= inventorySlice.actions;